...
impl<'a, AMT: AcquisitionModelApi + Deserialize<'a> + 'static> Deserialize<'a>
    for StorageModel<AMT>
{
...
impl<AMT: AcquisitionModelApi + Serialize + DeserializeOwned + 'static> StorageModelApi
    for StorageModel<AMT>
{
